...
tombolPesan.addEventListener("click", function (e) {
  ...
  if (nama.value == "" || destinasi.value == "" || status.value == "" || jumlah.value == "") {
    ...
    if (destinasi.value == "PINK BEACH(LABUAN BAJO)" && status.value == "wna") {
      harga = 200000;
      hargaPerTiket.innerText = harga + " (Dua Ratus Ribu)";
    } else if (destinasi.value == "PINK BEACH(LABUAN BAJO)" && status.value == "wni") {
      harga = 100000;
      hargaPerTiket.innerText = harga + " (Seratus Ribu)";
    } else if (destinasi.value == "PULAU PADAR (LABUAN BAJO)" && status.value == "Dewasa") {
      harga = 300000;
      hargaPerTiket.innerText = harga + " (Tiga Ratus Ribu)";
    } else if (destinasi.value == "PULAU PADAR (LABUAN BAJO)" && status.value == "Anak-anak") {
      harga = 200000;
      hargaPerTiket.innerText = harga + " (Dua Ratus Ribu)";
    } else if (destinasi.value == "DANAU KELIMUTU (ENDE)" && status.value == "Dewasa") {
      harga = 400000;
      hargaPerTiket.innerText = harga + " (Empat Ratus Ribu)";
    } else if (destinasi.value == "DANAU KELIMUTU (ENDE)" && status.value == "Anak-anak") {
      harga = 300000;
      hargaPerTiket.innerText = harga + " (Tiga Ratus Ribu)";
    }
